...
1. Create a base OWML mod following the [getting started guide.](https://owml.outerwildsmods.com/guides/getting-started). For this example we're calling our mod `DothrakiTranslation` but replace that with whatever language you're working on.
